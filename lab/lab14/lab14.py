...
def prune_min(t):
    ...
    if t.is_leaf() or len(t.branches) != 2:
        ...
        t.branches = [b1 if b1.label < b2.label else b2]
        return
...
class Check(object):
    ...
    def __init__(self, payable_to, amount):
        self.payable_to, self.amount, self.deposited = payable_to, amount, False
...
def reverse(lst):
    ...
    if lst == Link.empty:
        ...
        return foldl(lst, lambda llst, lnum: Link(lnum, llst), Link.empty)
